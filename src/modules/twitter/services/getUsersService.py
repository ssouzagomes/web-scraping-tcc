...
from modules.twitter.repositories import twitterRepository
from modules.twitter.services import getTweetsService

async def execute(headers):
  try:
    usernames = await twitterRepository.getAllUsernames()
    ...
    # await getTweetsService.execute(user_ids, headers)
